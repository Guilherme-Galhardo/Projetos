...
function getModel() {
    ...
    model.add(tf.layers.conv2d({inputShape: [28,28,1], kernelSize: 4, filters: 15, activation: 'relu'}));
    model.add(tf.layers.maxPooling2d({poolSize: [2,2]}));
    model.add(tf.layers.conv2d({kernelSize: 4, filters: 30, activation: 'relu'}));
    model.add(tf.layers.conv2d({kernelSize: 4, filters: 45, activation: 'relu'}));
    model.add(tf.layers.maxPooling2d({poolSize: [2,2]}));
